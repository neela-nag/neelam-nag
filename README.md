...
<div class="nn-hero">
  ...
  <h1>I build documentation systems that work for the people who use them.</h1>
  <p>Ten years documenting payment platforms, developer APIs, and knowledge systems — grounded in one question: <em>why is this person here, and what do they need to leave with?</em></p>
</div>

<div class="nn-stats">
  <div class="nn-stat">
    <span class="nn-stat-num">10+</span>
    <span class="nn-stat-label">Years experience</span>
  </div>
  <div class="nn-stat">
...
<div class="nn-philosophy">
  <p>Documentation is never really about documents. It is about helping people do things they could not do confidently before. I start with the user's task — not the product's structure, not the engineering team's mental model. What did this person come here to accomplish? What would success look like for them in the next five minutes? That question shapes every structural decision I make.</p>
</div>
